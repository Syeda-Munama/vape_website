...
const allProducts = [
  {
    ...
    brand: "Elf Bar",
    description:
      "Delicious blue raspberry lemonade flavor in a disposable vape.",
  ...
  },
  {
    ...
    brand: "XQS",
    description:
      "Refreshing blueberry mint pouches with a discreet nicotine hit.",
  ...
  },
  {
    ...
    flavour: "Lemon Tart",
    description:
      "Tangy lemon curd with buttery pastry base. A dessert vape classic.",
